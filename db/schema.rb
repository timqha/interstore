...
ActiveRecord::Schema.define(version: 20150714102841) do
  ...
  add_index "relations", ["order_id"], name: "index_relations_on_order_id"
  add_index "relations", ["product_id"], name: "index_relations_on_product_id"
